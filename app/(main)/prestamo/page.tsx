...
const LoanPage = () => {
	return (
		<div>
		<h1 className='my-8 font-bold' style={{ color: 'green' }}>Gestión de préstamos</h1>
		  <section className="container px-4 mx-auto">
			<div className="sm:flex sm:items-center sm:justify-between">
				<div>
					<div className="flex items-center gap-x-3">
						<h2 className="text-lg font-medium text-gray-800 dark:text-white">Préstamos</h2>
	
						<span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">50 préstamos activos</span>
					</div>
	
					<p className="mt-1 text-sm text-gray-500 dark:text-gray-300">Estos préstamos se han realizado en el último mes.</p>
				</div>
								...
								<tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
									<tr>
										...
										<td className="px-12 py-4 text-sm font-medium whitespace-nowrap">
											<div className="inline px-3 py-1 text-sm font-normal rounded-full text-indigo-500 gap-x-2 bg-indigo-100/60 dark:bg-gray-800">
												Cable
											</div>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
										...
										<td className="px-4 py-4 text-sm whitespace-nowrap">
											<div className="flex items-center">
												...
												<h4 className='px-2'>laura.tascon</h4>
											</div>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">13/04/2024</h4>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">23/04/2024</h4>
										</td>
									...
									<tr>
										...
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<div className="inline px-3 py-1 text-sm font-normal rounded-full text-pink-800 gap-x-2 bg-pink-100/90 dark:bg-gray-800">
												Vencido
											</div>
										</td>
										<td className="px-4 py-4 text-sm whitespace-nowrap">
											<div className="flex items-center">
												...
												<h4 className='px-2'>hernando.silva</h4>
											</div>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">07/04/2024</h4>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">17/04/2024</h4>
										</td>
										<td className="pl-4 pr-4 text-center">
											<button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-2 rounded mr-2">
												<HiOutlinePrinter size={16} />
									...
									<tr>
										...
										<td className="px-4 py-4 text-sm whitespace-nowrap">
											<div className="flex items-center">
												...
												<h4 className='px-2'>silvana.montoya</h4>
											</div>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">14/04/2024</h4>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">24/04/2024</h4>
										</td>
										<td className="pl-4 pr-4 text-center">
											<button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-2 rounded mr-2">
												<HiOutlinePrinter size={16} />
									...
									<tr>
										...
										<td className="px-4 py-4 text-sm whitespace-nowrap">
											<div className="flex items-center">
												...
												<h4 className='px-2'>carlos.chica</h4>
											</div>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">16/04/2024</h4>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">26/04/2024</h4>
										</td>
										<td className="pl-4 pr-4 text-center">
											<button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-2 rounded mr-2">
												<HiOutlinePrinter size={16} />
									...
									<tr>
										...
										<td className="px-4 py-4 text-sm whitespace-nowrap">
											<div className="flex items-center">
												<img className="object-cover w-6 h-6 -mx-1 border-2 border-white rounded-full dark:border-gray-700 shrink-0" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=256&q=80" alt=""/>
												<h4 className='px-2'>clara.zapata</h4>
											</div>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">11/03/2024</h4>
										</td>
										<td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
											<h4 className="text-gray-700 dark:text-gray-200">11/04/2024</h4>
										</td>
										<td className="pl-4 pr-4 text-center">
											<button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-2 rounded mr-2">
												<HiOutlinePrinter size={16} />
